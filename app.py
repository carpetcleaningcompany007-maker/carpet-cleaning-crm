...
XERO_SCOPES = "offline_access app.connections accounting.settings accounting.settings.read accounting.contacts accounting.contacts.read accounting.invoices accounting.invoices.read"
