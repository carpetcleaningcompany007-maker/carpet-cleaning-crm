...
def add_website_form_cors_headers(response):
    ...
    if request.method == "GET" and session.get("logged_in") and "text/html" in content_type:
        ...
        response.headers["X-CRM-UI-Version"] = "20260906.53"
...
def pwa_service_worker():
    source = """const CACHE='carpet-clean-pro-v37';
	const SHELL=['/offline','/static/app-theme.css?v=20260906-40','/static/dashboard-exact.css?v=20260906-6','/static/customer-record-premium.css?v=20260906-3','/static/app.js?v=mobile-more-20260905-1','/static/site/site-icon-512.png'];
