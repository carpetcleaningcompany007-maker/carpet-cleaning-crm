...
class AICustomerReplyTests(unittest.TestCase):
    ...
    def test_generation_uses_enquiry_and_records_usage_without_sending(self):
        ...
        self.assertIn("I've just received the information you've sent over and had a look through it", instructions)
    ...
    def test_conversation_prompt_uses_saved_carpet_option_names(self):
        ...
        self.assertIn('like for like price match', instructions)
    ...
    def test_initial_reply_drops_early_access_and_address_request(self):
        ...
        self.assertTrue(polished.endswith('Thanks,\nPaul\nThe Carpet Cleaning Company'))
